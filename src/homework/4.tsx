...
interface SelectedMenu { id: MenuIds; }
interface MenuSelected { selectedMenu: SelectedMenu; }
...
function MenuProvider({ children }: PropsProvider) {
    ...
    const [selectedMenu, setSelectedMenu] = useState<SelectedMenu>({ id: 'first' }); // Додати тип для SelectedMenu він повинен містити { id }
